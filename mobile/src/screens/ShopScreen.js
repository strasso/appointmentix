  ...
  return (
    <View>
      ...
      <View style={styles.shopTabsRow}>
        <ShopTabButton styles={styles} label="Browse" active={shopTab === 'browse'} onPress={() => setShopTab('browse')} />
        <ShopTabButton
          styles={styles}
        ...
        <View>
          ...
          <View style={styles.sectionHeader}>
            ...
            <Text style={styles.sectionLead}>
              Waehle zuerst einen Bereich, dann siehst du die passenden Optionen deiner Klinik.
            </Text>
          </View>
      ...
      {shopTab === 'membership' && (
        <View>
          <View style={[styles.sectionHeader, styles.sectionHeaderCompact]}>
            ...
            <Text style={styles.sectionLead}>
              Pakete fuer Patientinnen, die regelmaessig wiederkommen und bessere Konditionen wollen.
            </Text>
          </View>
      ...
      {shopTab === 'treatments' && (
        <View>
          <View style={[styles.sectionHeader, styles.sectionHeaderCompact]}>
            ...
            <Text style={styles.sectionTitle}>Alle Treatments im Ueberblick</Text>
            <Text style={styles.sectionLead}>
              Eine klare Liste fuer schnelles Scannen, Vergleichen und spaeteres Buchen.
            </Text>
          </View>
          {treatments.map((item) => (
