...
export default function BottomNavigation({ styles, mainTab, switchMainTab }) {
  return (
    <View style={styles.bottomBar}>
      ...
      <BottomTab styles={styles} label="Start" active={mainTab === 'home'} onPress={() => switchMainTab('home')} />
      ...
      <BottomTab styles={styles} label="Vorteile" active={mainTab === 'rewards'} onPress={() => switchMainTab('rewards')} />
