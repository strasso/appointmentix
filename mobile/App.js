...
const styles = StyleSheet.create({
  ...
  headerAvatarGlow: {
    ...
    height: 42,
    borderRadius: 999,
    backgroundColor: 'rgba(20,151,232,0.18)',
  },
  headerAvatarText: {
    color: '#176CB8',
    fontWeight: '800',
  ...
  headerClinic: {
    ...
    color: THEME.brandStrong,
    marginTop: 0,
    backgroundColor: 'rgba(255,247,252,0.98)',
    borderWidth: 1,
    borderColor: 'rgba(237,198,226,0.88)',
    borderRadius: 999,
    overflow: 'hidden',
  ...
  heroAeroRing: {
    ...
    borderRadius: 999,
    borderWidth: 3,
    borderColor: 'rgba(20,151,232,0.24)',
  },
  heroAeroDot: {
    position: 'absolute',
    width: 28,
  ...
  heroGlowPrimary: {
    ...
    height: 196,
    borderRadius: 999,
    backgroundColor: 'rgba(20,151,232,0.14)',
  },
  heroGlowSecondary: {
    position: 'absolute',
    bottom: -62,
    ...
    height: 188,
    borderRadius: 999,
    backgroundColor: 'rgba(241,124,199,0.15)',
  },
  heroTopRow: {
    flexDirection: 'row',
    alignItems: 'center',
  ...
  heroCta: {
    alignSelf: 'flex-start',
    backgroundColor: '#1C94EA',
    borderColor: 'rgba(219,241,255,0.96)',
    borderWidth: 1,
    borderRadius: 20,
  ...
  articleEditorialGlow: {
    ...
    height: 148,
    borderRadius: 999,
    backgroundColor: 'rgba(20,151,232,0.10)',
  },
  articleCompactGrid: {
    gap: 14,
    marginBottom: 4,
  ...
  callNowCta: {
    ...
    borderRadius: 20,
    borderWidth: 1,
    borderColor: 'rgba(219,241,255,0.86)',
    paddingVertical: 14,
    alignItems: 'center',
    shadowColor: '#59DDF8',
    shadowOpacity: 0.24,
  ...
  categoryTileActive: {
    borderColor: BORDER_TINT,
    backgroundColor: 'rgba(236,249,255,0.98)',
    shadowColor: '#59DDF8',
    shadowOpacity: 0.18,
    shadowRadius: 22,
    shadowOffset: { width: 0, height: 10 },
  ...
  bottomTabBtnCenterActive: {
    backgroundColor: '#1A87D8',
    borderColor: 'rgba(233,247,255,0.96)',
  },
  bottomTabActiveGlow: {
    position: 'absolute',
    left: 10,
